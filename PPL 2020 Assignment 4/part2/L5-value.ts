...
///////////////////////////////////////// i added the TUPLe
export type Value = SExpValue|TupleValue ;
...
////////////////////////////// I ADDED::::::::::::::::::::::::::::::
//export type TupleValue = Sexp[];
//export makeTupleValue = (exps:Sexp[]): TupleValue =>
export interface TupleValue {tag: "TupleValue"; vals: Value[]; }
export const makeTuple = (vals: Value[]): TupleValue => ({tag: "TupleValue", vals: vals});
export const isTupleValue = (x: any): x is TupleValue => x.tag === "TupleValue";
