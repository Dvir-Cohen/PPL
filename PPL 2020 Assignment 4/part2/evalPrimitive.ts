...
import { Value, isSymbolSExp, isCompoundSExp, makeCompoundSExp, makeEmptySExp, isEmptySExp, CompoundSExp, EmptySExp, SExpValue } from "./L5-value";
import { Result, makeFailure, makeOk } from "../shared/result";
import { allT, first, rest } from "../shared/list";
import { isNumber, isString, isBoolean } from "../shared/type-predicates";
import { reduce } from "ramda";

export const applyPrimitive = (proc: PrimOp, args: SExpValue[]): Result<Value> =>
...
const cdrPrim = (v: Value): Result<Value> =>
 ...
 export const listPrim = (vals: SExpValue []): EmptySExp | CompoundSExp =>
