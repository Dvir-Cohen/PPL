...
describe('L4 Normal Eval', () => {
    ...
    //                   (- #t 1)
    //                 (* n1 (power n1 (- n2 1) ))))))
    //       (power 2 3))`), evalNormalProgram)).to.deep.equal(makeOk(8));
    // });
    ...
    //              -
    //              (+ 1 (degree(/ num 10)))))))
    //       (degree 123))`), evalNormalProgram)).to.deep.equal(makeOk(3));
    // });
    ...
    //              1
    //              (+ 1 (length(cdr lst))))))
    //       (if (< (length (list 3 5 6 ))5) (length (list 3 5 6 )) (length(*))))`), evalNormalProgram)).to.deep.equal(makeOk(3));
    // });
